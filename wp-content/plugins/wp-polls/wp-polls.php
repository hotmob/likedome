...
function vote_poll() {
	...
	if(!empty($_REQUEST['vote'])) {
		...
		$poll_aid = $_REQUEST["poll_$poll_id"];
...
function create_poll_table() {
	...
	$create_table['pollsa'] = "CREATE TABLE $wpdb->pollsa (".
									...
									"polla_votes int(10) NOT NULL default '0',".
                                                                        "poll_answers_custom varchar(200) character set utf8 DEFAULT NULL,".
                                                                        "poll_answers_image varchar(200) character set utf8 DEFAULT NULL,".
