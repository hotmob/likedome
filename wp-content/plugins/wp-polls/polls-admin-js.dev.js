...
function add_poll_answer_add() {
	jQuery('#poll_answers').append('<tr id="poll-answer-' + count_poll_answer + '"><th width="20%" scope="row" valign="top"></th><td width="80%"><input type="text" size="10" maxlength="20" name="polla_answers[][0]" /><input type="text" size="10" maxlength="20" name="polla_answers[][1]" /><input type="text" size="50" maxlength="160" name="polla_answers[][2]" />&nbsp;&nbsp;&nbsp;<input type="button" value="' + pollsAdminL10n.text_remove_poll_answer + '" onclick="remove_poll_answer_add(' + count_poll_answer + ');" class="button" /></td></tr>');
	count_poll_answer++;
	reorder_answer_num();
}
...
function add_poll_answer_edit() {
	jQuery('#poll_answers').append('<tr id="poll-answer-new-' + count_poll_answer_new + '"><th width="20%" scope="row" valign="top"></th><td width="60%"><input type="text" size="10" maxlength="20" name="polla_answers_new[][0]" /><input type="text" size="10" maxlength="20" name="polla_answers_new[][1]" /><input type="text" size="50" maxlength="160" name="polla_answers_new[][2]" />&nbsp;&nbsp;&nbsp;<input type="button" value="' + pollsAdminL10n.text_remove_poll_answer + '" onclick="remove_poll_answer_edit(' + count_poll_answer_new + ');" class="button" /></td><td width="20%" align="' + pollsAdminL10n.text_direction + '">0 <input type="text" size="4" name="polla_answers_new_votes[]" value="0" onblur="check_totalvotes();" /></td></tr>');
