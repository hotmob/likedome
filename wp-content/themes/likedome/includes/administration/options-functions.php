...
function padd_theme_add_admin() {
	...
	add_theme_page("选项", "选项", 'edit_themes', basename(__FILE__), 'padd_theme_admin');
}
...
function padd_theme_admin() {
	...
	if ( $_REQUEST['reset'] ) echo '<div id="message" class="updated fade"><p><strong>设置已经被重置.</strong></p></div>';
