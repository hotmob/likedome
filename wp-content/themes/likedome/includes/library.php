...
<div id="tab1">
	<ul class="tab_menu sideMenu">
		<li class="select">今日新闻</li>
		<li>昨日新闻</li>
		<li>官方新闻</li>
	</ul>
        <div class="clear"></div>
        <div class="topNews margin-t18"> <a href="比赛页面.html" target="_blank" class="fl"><img src="pic/01.jpg" /></a>
			...
			<div class="comment-interior append-clear">
				...
				<div class="comment-details">
					<div class="comment-details-interior">
						...
						<p class="comment-notice"><?php _e('我的评论正在等待审核.') ?></p>
						<?php endif; ?>
					</div>
				</div>
