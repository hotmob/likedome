/*
** usefor: 页面加载时首页弹窗显示,cookie设置30分钟，即30分钟内只弹一次
** create: 2011/08/15
*/
...
var paypopupURL="http://www.766.com/";
...
var casalef='width=920,height=800,toolbar=1,location=1,titlebar=1,menubar=1,scrollbars=1,resizable=1,directories=1,status=1';
var l = (screen.width -  920) / 2 ;
var t = (screen.height - 800) / 2 ;
var ispop=get_cookie('homepopedper30min');
function Set()
{ 
　　var Then = new Date()　　　　 
　　Then.setTime(Then.getTime() + 30*60*1000 )
　　document.cookie = "homepopedper30min=yes;expires="+ Then.toGMTString() 
}
if (ispop=='')
{ 
 Set();
 keyrunpop = fStart(paypopupURL,'',casalef+',left='+l+',top='+t);
 keyrunpop.blur();
}