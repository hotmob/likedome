			...
			*/
			...
			picShow.timerMe=setInterval(function(){
							...
							if(a%88==0){
								...
								a-=1;picShow.$("smallPhoto").style.left=a+"px"
							}
						},1)}};
...
function addCount(a){
	...
	if(picShow.$("iframeP")||a!==0){
		a="http://"+picShow.SiteName+".766.com/niersen_tongji.htm?"+a;
		if(picShow.isIE){
			document.all.iframeP.contentWindow.location=''
		}else{
